...
<Title subtitle={'Engage with Strategic, Real-Time Digital Out Of Home Advertising'}>Why Choose Us</Title>
 <div className=" flex gap-20 mx-auto w-full justify-center ">
      <CometCard>
      <button
        type="button"
        className="my-10 flex w-80 cursor-pointer flex-col items-stretch rounded-[16px] border-0 saturate-0 hover:saturate-100 duration-300 bg-[#1F2121] p-2 md:my-20 md:p-4"
      ...
      >
        ...
        <div className="mt-2 flex flex-shrink-0 items-center justify-between p-2 font-mono text-white">
          ...
          <img src="/logo-w.svg" className=" mx-auto h-[30px]" alt="" />
        </div>
      </button>
    </CometCard>
        <CometCard>
      <button
        type="button"
        className="my-10 flex w-80 cursor-pointer flex-col items-stretch rounded-[16px] border-0 bg-[#1F2121] p-2 saturate-0 hover:saturate-100 duration-300 md:my-20 md:p-4"
        aria-label="View invite F7RA"
        style={{
          transformStyle: "preserve-3d",
          transform: "none",
